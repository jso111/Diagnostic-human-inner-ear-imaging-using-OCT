...
if (nargin>2) & ~isempty( axis_handle ) & (test>0)
    ...
    plot( new_ver_line(1,:),new_ver_line(2,:),'g','LineStyle','-.','LineWidth',1.5 );
    plot( new_horz_line(1,:),new_horz_line(2,:),'g','LineStyle','-.','LineWidth',1.5  );
    plot( rotated_ellipse(1,:),rotated_ellipse(2,:),'Color',[246/255 83/255 20/255],'LineWidth',2 );
